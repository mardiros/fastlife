...
.. jinjax:component:: Radio(label: str, name: str, value: str, id: str | None, checked: bool = False, disabled: bool = False, onclick: str | None = None, div_class: str | None = None, class_: str | None = None, label_class: str | None = None)
    ...
    :param div_class: css class for the div node, defaults to :attr:`fastlife.templating.renderer.constants.Constants.RADIO_DIV_CLASS`
    :param class: css class for the input node, defaults to :attr:`fastlife.templating.renderer.constants.Constants.RADIO_INPUT_CLASS`
    :param label_class: css class for the label node, defaults to :attr:`fastlife.templating.renderer.constants.Constants.RADIO_LABEL_CLASS`
