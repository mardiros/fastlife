...
.. jinjax:component:: A(href: str, id: str | None = None, hx_target: str = '#maincontent', hx_select: str | None = None, hx_swap: str = 'innerHTML show:body:top', hx_push_url: bool = True, disable_htmx: bool = False, content: Any)
